    ...
    <div>
      ...
      <div className='my-10 flex flex-col md:flex-row justify-center gap-10 mb-28'>
        ...
        <div className='flex flex-col justify-center items-start gap-6'>
          ...
          <p className='text-gray-500'>Forever Clothing <br /> 123, Maple Street, <br />Andheri West, Mumbai - 400053 <br />Maharashtra, India</p>
          <p className='text-gray-500'>Tel : +91 22 4001 2345 <br /> EMail : contact@foreverclothing.com</p>
